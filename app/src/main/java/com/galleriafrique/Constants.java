...
public class Constants {
    public static final String ENDPOINT                     = "http://tilte-api.herokuapp.com/api";
    ...
    public static final String PARAM_USER_UID               = "uid";
    ...
    public static final String PARAMS_OAUTH_PROVIDER        = "provider";
    public static final String PARAM_USER_PROFILE_PHOTO_URL = "profile_photo_url";
    ...
    public static final String FACEBOOK_LOGIN_FAILED        = "Facebook login failed. Try again";
    public static final String REPOST_FAILED                = "Repost failed. Try again";
